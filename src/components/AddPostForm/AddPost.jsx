            ...
            <div className='flex flex-col items-start w-[70%] px-10 py-10 rounded-lg my-[10px] bg-blue-200 gap-[10px] justify-center'>
                ...
                <form className='flex w-[100%] flex-col gap-5 justify-center'>
                    <div className='flex flex-col items-start'>
                        ...
                        <input className='w-[100%] outline-none border-2 border-blue-800 px-2 py-1 rounded-sm ' type="text" name="title" id="title" />
                    </div>
                    <div className='flex flex-col items-start'>
                    ...
                    <div className='flex flex-col items-start'>
                        ...
                        <input className='w-[100%] outline-none border-2 border-blue-800 px-2 py-1 rounded-sm ' type="text" name="tags" id="tags" />
                    </div>
                    <div>
